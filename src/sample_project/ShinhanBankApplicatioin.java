...
public class ShinhanBankApplicatioin {
...
//    // 입력 --> 비밀 번호
//    // 처리 --> 계좌 개설 완료 / Transaction
//
////    Client client = clientMap.get(clientNo);
//    if(client == null) { // 신규고객
//      // 고객 정보 생성 후 map 에 추가
//    } else { // 기존 고객
//    }
//    // 처리 --> 계좌개설 / Client, Account
//    while(true) {
//      // 계좌번호는 랜덤하게 생성하고 기존에 없는 코드임을 확인하고 개설
//      // 기존에 존재하는 코드이면 다시
//    }
//    Account a1 = new Account(BankCode.신한, "11111", client, 0L);
//
