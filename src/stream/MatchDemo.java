...
public class MatchDemo {
  public static void main(String[] args) {
    ...
    if (nations.allMatch(nation -> nation.getPopulation() > 100)) { // 모든국가의 인구가 전부 1억이 넘습니까?
    ...
    first.ifPresentOrElse(nation -> System.out.println("첫번째 국가는 "+nation.getName()), // cosumer 컨슈머
                            () -> System.out.println("해당하는 국가를 찾을 수 없습니다."));  // ranable 러너블
